module Cldr.Belarusian.Taraškievica exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Belarusian (Taraškievica).

This is identical to the Belarusian version.
...
countryCodeToName =
    Cldr.Belarusian.countryCodeToName