module Cldr.Bosnian.Latin exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Bosnian (Latin).

This is identical to the Bosnian version.
...
countryCodeToName =
    Cldr.Bosnian.countryCodeToName