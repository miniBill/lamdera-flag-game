module Cldr.Croatian.BosniaAndHerzegovina exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Croatian - Bosnia & Herzegovina.

This is identical to the Croatian version.
...
countryCodeToName =
    Cldr.Croatian.countryCodeToName