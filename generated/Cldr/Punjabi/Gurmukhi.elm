module Cldr.Punjabi.Gurmukhi exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Punjabi (Gurmukhi).

This is identical to the Punjabi version.
...
countryCodeToName =
    Cldr.Punjabi.countryCodeToName