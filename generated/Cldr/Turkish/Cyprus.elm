module Cldr.Turkish.Cyprus exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Turkish - Cyprus.

This is identical to the Turkish version.
...
countryCodeToName =
    Cldr.Turkish.countryCodeToName