module Cldr.Portuguese.SãoToméAndPríncipe exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Portuguese - São Tomé & Príncipe.
...
countryCodeToName =
    Cldr.Portuguese.Portugal.countryCodeToName