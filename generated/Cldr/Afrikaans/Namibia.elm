module Cldr.Afrikaans.Namibia exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Afrikaans - Namibia.

This is identical to the Afrikaans version.
...
countryCodeToName =
    Cldr.Afrikaans.countryCodeToName