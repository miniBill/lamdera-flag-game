module Cldr.Norwegian.Bokmål exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Norwegian Bokmål.

This is identical to the Norwegian version.
...
countryCodeToName =
    Cldr.Norwegian.countryCodeToName