module Cldr.Norwegian.Bokmål.SvalbardAndJanMayen exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Norwegian Bokmål - Svalbard & Jan Mayen.

This is identical to the Norwegian Bokmål version.
...
countryCodeToName =
    Cldr.Norwegian.Bokmål.countryCodeToName