module Cldr.Serbian.Cyrillic exposing (countryCodeToName)
...
{-| Name for `CountryCode` in Serbian (Cyrillic).

This is identical to the Serbian version.
...
countryCodeToName =
    Cldr.Serbian.countryCodeToName