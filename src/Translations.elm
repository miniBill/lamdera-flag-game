module Translations exposing (I18n, Language(..), africa, antarctica, asia, change, continents, currentLanguage, difficulty, easy, europe, finalScore, flag, gameLanguage, gameLength, guess, hard, historical, include, init, languageFromString, languageToString, languages, load, name, next, normal, northAmerica, oceania, partiallyRecognized, play, playAgain, possibleAnswers, score, search, southAmerica, states, territories, title)
...
historical : I18n -> String
historical (I18n lang) =
    case lang of
        De ->
            "Historical"
...
partiallyRecognized : I18n -> String
partiallyRecognized (I18n lang) =
    case lang of
        De ->
...
territories : I18n -> String
territories (I18n lang) =
    case lang of
        De ->
            "Territorien"
