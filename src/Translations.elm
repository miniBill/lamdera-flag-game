module Translations exposing (I18n, Language(..), change, currentLanguage, difficulty, easy, finalScore, flag, gameLanguage, gameLength, guess, hard, include, init, languageFromString, languageToString, languages, load, name, next, normal, play, playAgain, possibleAnswers, score, search, states, statesAndTerritories, title)
