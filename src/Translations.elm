module Translations exposing (I18n, Language(..), back, change, currentLanguage, difficulty, easy, finalScore, flag, gameLanguage, gameLength, guess, hard, include, init, languageFromString, languageToString, languages, load, name, next, normal, play, possibleAnswers, score, search, states, statesAndTerritories, title)
